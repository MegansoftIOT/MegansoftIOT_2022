...
{
    // default connection
    public static $dbname = 'MeganIOT'; // Your database name
    public static $dbuser = 'iotuser'; // Your database username
    public static $dbpass = 'Welcome@123'; // // Your database password
